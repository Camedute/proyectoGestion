...
export class RegisterComponent {
  ...
  constructor(private firebaseService: FirebaseService, private router: Router, private navCtrl: NavController,private toastController: ToastController) {}
  ...
  async registerUser() {
    ...
    this.firebaseService.sendData(this.user.username, this.user.email, this.user.password)
      .subscribe(
        response => {
          console.log('Datos enviados correctamente', response);
          // Puedes agregar lógica adicional aquí después de enviar los datos
        },
        error => {
